...
def setup():
    ...
    kde4.configure("-DBUILD_csharp=OFF -DENABLE_KROSSFALCON=OFF -DENABLE_PHP-QT=ON -DBUILD_smoke=OFF -DRUBY_SITE_LIB_DIR=/usr/lib/ruby/site_ruby/1.8 -DRUBY_SITE_ARCH_DIR=/usr/lib/ruby/site_ruby/1.8/i686-linux")
