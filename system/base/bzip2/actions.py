...
def install():
    ...
    pisitools.dosym("/lib/libbz2.so.1", "/lib/libbz2.so")
    pisitools.dosym("/lib/libbz2.so.1.0", "/lib/libbz2.so.1")
    pisitools.dosym("/lib/libbz2.so.%s" % libversion, "/lib/libbz2.so.1.0")
